...
export const eai6402Lecture20260822 = {
  ...
  "hi": {
    ...
    "summary": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "व्याख्यान समय, स्टाफ, बिस्तर, धन और अन्य संसाधनों को भी सीमित गणना के रूप में देखता है। किसी गंभीर रोगी के आने पर केवल first-come, first-served नियम अनुपयुक्त हो सकता है; data-informed system को केवल arrival order नहीं, बल्कि urgency और cost को भी represent करना चाहिए। यह संकेत देता है कि objective design और stakeholder value data pipeline से अलग नहीं हैं।",
      ...
      },
      {
        ...
        "paragraphs": [
          "एक छात्रावास हर दिन समोसे की सेवा करता है। 100 छात्रों में से 30 इसे बनाए रखना चाहते हैं, जबकि 70 बदलाव चाहते हैं। यदि कोई form प्रत्येक असंतुष्ट छात्र को free-text box में कोई भी विकल्प लिखने देता है, तो votes इडली, वड़ा पाव, सैंडविच और कई अन्य विकल्पों में बँट जाते हैं। तब समोसा केवल 30 प्रतिशत के साथ जीत सकता है। परिणाम वास्तविक बहुमत की preference नहीं, बल्कि feedback instrument को दर्शाता है।",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "इसे सार्वभौमिक सांख्यिकीय शब्दावली के बजाय instructor के conceptual distinction के रूप में लें। मुख्यधारा के missing-data analysis में missingness को आमतौर पर MCAR, MAR और MNAR जैसे mechanisms से describe किया जाता है। व्यावहारिक सीख यह है: imputation या missingness handling लागू करने से पहले जाँचें कि value वास्तव में कहीं और उपलब्ध है या नहीं।"
        ]
      }
    ],
    "courseSignals": {
    ...
    "keyTerms": [
      ...
      {
        "term": "डेटा सिद्धि",
        "definition": "डेटा कहाँ से आया, कैसे collect किया गया और समय के साथ कैसे बदला—इसका इतिहास।"
      }
    ],
    "insights": [
      {
      ...
      },
      {
        ...
        "body": "निर्णय को define करें, representative evidence collect करें, data पर model fit करें, cost-aware metrics चुनें, human oversight रखें, outcomes inspect करें और optimize करें। बाद में आने वाला meta-learning algorithm इस बड़े system का केवल एक हिस्सा है।"
      }
    ],
    "resources": [
      {
      ...
      },
      {
        ...
        "creator": "NIST/SEMATECH e-Handbook",
        "why": "व्याख्यान के सर्वेक्षण के उदाहरणों को यादृच्छिककरण, स्तरीकरण, परिशुद्धता और सिस्टेमैटिक पक्षपात नियंत्रण से जोड़ता है।",
        "url": "https://itl.nist.gov/div898/handbook/ppc/section3/ppc332.htm"
      },
      {
        "type": "डेटासेट",
    ...
    "quiz": [
      ...
      },
      {
        ...
        "options": [
          "सुपरवाइज़्ड लर्निंग labels का उपयोग करती है; अनसुपरवाइज़्ड लर्निंग target labels पर निर्भर नहीं करती",
          "सुपरवाइज़्ड लर्निंग images का उपयोग करती है; अनसुपरवाइज़्ड लर्निंग text का उपयोग करती है",
