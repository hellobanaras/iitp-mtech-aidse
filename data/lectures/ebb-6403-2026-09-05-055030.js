...
export const ebb6403Lecture20260905055030 = {
  en: {
    title: "Public-key cryptography foundations: modular arithmetic, trapdoor functions, and security properties",
    lede: "This lecture introduces public-key cryptography through key pairs, modular arithmetic, trapdoor one-way functions, and the security properties that prepare the ground for RSA and ElGamal.",
    instructionalInterval: "01:50–1:16:09 source time (2× visible-tab capture; opening setup excluded; source video ended after the final instruction)",
    reviewLevel: "View-only recording; beginning/10%/25%/50%/75%/90%/near-end sweep, 2× visible-tab video+audio capture, source-time-restored transcript, 74 sampled frames, slide-candidate evidence, and both teaching boundaries verified",
    coverage: [
