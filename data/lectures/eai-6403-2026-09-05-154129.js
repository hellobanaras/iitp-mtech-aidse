// English-only publication unit for the verified 5 September 2026 recording.
const quizSeed = [
...
export const eai6403Lecture20260905 = {
  en: {
    title: "Transformers, BERT, and modern language models",
    lede: "This lecture explains the Transformer encoder-decoder architecture, self-attention, multi-head attention, positional encoding, and the path from the 2017 paper to BERT and large language models.",
    instructionalInterval: "00:06–37:41 source time (visible-tab capture at 2×; participant-only tail excluded)",
    reviewLevel: "Full-timeline triage at beginning/10%/25%/50%/75%/90%/near-end, 2× visible-tab capture, 38 frame samples, and source-time-restored transcript",
    coverage: [
