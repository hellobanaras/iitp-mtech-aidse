...
The permitted visible-tab video-plus-audio capture ran alone at 2× from the verified start, with the endpoint bounded to the final sustained teaching segment; the recording tab was closed before processing. The retained artifact and timing sidecar are under ignored `.course-data/captures/ebb-6402/2026-09-03/`. Local processing verified audio/video, restored source-time timestamps, and sampled 83 frames. The English-only note `ebb-6402-2026-09-03-180128` covers KYC and enhanced due diligence, monitoring and SAR/STR reporting, FIU and FATF architecture, risk-based supervision, AML governance, technology risks, and stablecoin policy. It includes seven source-time visual references, seven summary sections, five expert insights, explicit empty transcript-derived signal categories, optional practice, six reliable resources, the accessible blockchain-policy visual, the public `StableGuard` capstone, and exactly 25 explained MCQs. The queue transaction is prepared for validation and publication.
...
#### ECS 6402 — 27 August 2026, 20:34:55 source

`Selected Topics in Wireless Networks-20260827_203455-Meeting Recording.mp4` is a 192 MB, 1h 19m 23s view-only source with no visible provider Download action. The required beginning/10%/25%/50%/75%/90%/near-end sweep found sustained OneNote whiteboard teaching throughout: the carrier and communication-chain model at 00:07, exchange management and direction modes, CRC/checksum error handling, flow control, addressing and routing, analog/digital signals, line coding, noise and receiver estimation, SNR and matched filtering, transmission media, multiplexing, compression, and the final efficiency/course-roadmap summary through 01:18:57. No waiting-room-only start or post-class idle tail was present, so the source is `canonical`.
...
#### EBB 6403 — 29 August 2026, 05:35:54 source
