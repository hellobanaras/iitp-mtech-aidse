...
English and Hindi live in the same module and render together at one clean `#/lecture/<id>` URL. Source timecodes, formulas, URLs, section ordering, and MCQ answer indexes must match across the two columns. There are no language-specific public routes.
