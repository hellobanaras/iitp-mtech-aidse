...
- `program/` — program-wide curriculum, syllabus, and permitted institute documents
...
Optionally add `_index.json` inside a resource folder to provide better metadata. Keys may be filenames or relative paths:
